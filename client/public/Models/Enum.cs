...
public abstract class Enum : IComparable
{
    ...
    protected Enum(int id, string name) => (Id, Name) = (id, name);
    ...
    public static int AbsoluteDifference(Enum firstValue, Enum secondValue)
    {
    ...
    private static T Parse<T, K>(K value, string description, Func<T, bool> predicate) where T : Enum
    {
