...
{
    public static IQueryable<EntityWithTranslationsDto> GetEntityWithTranslations<T, J>(this EfCoreContext ctx, Func<T, string> id)
        where T : class
        where J : Translate
    {
        ...
        var query = entities
            ...
            .Select(g => new EntityWithTranslationsDto
            {
                Key = g.Key,
                Translations = g.Select(x => new TranslationDto
                {
